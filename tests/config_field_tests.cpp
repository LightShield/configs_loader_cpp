...
TEST(ConfigFieldTest, VerifierRejectsInvalidValue) {
    ConfigField<int> field{42, {}, false, [](const int& val) { return val > 0; }};
...
TEST(ConfigFieldTest, StringFieldWorks) {
    ConfigField<std::string> field{"default"};
